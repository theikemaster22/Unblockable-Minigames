...
To run these games, just double click on the files in a file manager app and they will open in a browser.

This game is unblockable from many schools because it is a file executable, most school administration playforms/blockers can only see things like websites and urls so this is pretty much gauranteed to be unblockable.
